      ...
      setTimeout(() => {
        ...
        existingBranches.forEach((branch) => {
          ...
          if (officeLat !== null && officeLng !== null) {
            points.push([officeLat, officeLng]);
          }
        });
...
export default function CoverageRadiusMap({
  ...
  /**
   * Use this for overall Nepal map.
   * Example:
   * viewMode="nepal"
   */
  viewMode = "normal",
  ...
  }, [isNepalOverview, latitude, longitude, existingLocations]);
    ...
    <Space direction="vertical" size={12} style={{ width: "100%" }}>
      ...
      >
        ...
        >
          ...
          {latitude !== null && longitude !== null && !isNepalOverview && (
            <Fragment>
      ...
      <Space wrap>
        {isNepalOverview ? (
          <>
            <Text type="secondary">Nepal Overview:</Text>
            <Text strong>
              Showing all allocated main branch and sub-branch locations
            </Text>
          </>
        ) : (
          <>
